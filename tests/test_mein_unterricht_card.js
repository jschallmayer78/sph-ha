...
ck("Offenes Fach rot",h.includes(".subject:not(.complete) .name{color:var(--error-color"));
ck("Offen-Badge rot",h.includes(".badge.open{background:var(--error-color"));
ck("Offene Themen rot",h.includes(".topics{color:var(--error-color"));
